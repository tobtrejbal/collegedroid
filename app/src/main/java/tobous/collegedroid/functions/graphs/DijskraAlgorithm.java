...
public class DijskraAlgorithm {
     ...
     */
    public LinkedList<Vertex> getPath(Vertex target, boolean reverse) {
    ...
    public LinkedList<Vertex> getPathToConnector(boolean reverse) {
        List<Vertex> stairs = new ArrayList<Vertex>();
        ...
        for(Vertex vertex : stairs) {

            path = getPath(vertex, reverse);
        ...
        //Log.v(shortestPath.get(0).getId()+"nejkratsi","");
        return shortestPath;
    }
